module.exports = {
    ...
    'Problem 1': browser => {
        browser
            ...
            .setValue('[name="nameEntry"]', 'Ruby Estrada') //The name on line 8 has to be Ruby Estrada
    ...
    'Problem 2': browser => {
        browser
            .click('[name="employee5"]')    // Square brackets need to be put before and after the locator
                                            // on line 16. 
    ...
    'Problem 3': browser => {
        ...
        browser
            .click('[name="employee1"]')
            .expect.element('[name="nameEntry"]').value.to.equal('Bernice OrtizNew Person').before(2000)
    },      // On line 40, outcome is coded as 'Bernice OrtizNew Person'. It should be 'New Person'.
    'Problem 4': browser => {
        browser
            .click('[name="employee5"]')
            .clearValue('[name="nameEntry"]')
